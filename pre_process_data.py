...
def latest_trade_record(trade_records):
    trade= trade_records.select("trade_dt","symbol","exchange","event_tm","event_seq_nb","arrival_tm","trade_pr")
    ...
    trade_grouped = trade_grouped.select("trade_dt","symbol","exchange","event_tm","event_seq_nb","arrival_tm","trade_pr")
    return trade_grouped

def latest_quote_record(quote_records):
    quote = quote_records.select("trade_dt","symbol","exchange","event_tm","event_seq_nb","arrival_tm","bid_pr","bid_size","ask_pr","ask_size")
    ...
    quote_grouped = quote_grouped.select("trade_dt","symbol","exchange","event_tm","event_seq_nb","arrival_tm","bid_pr","bid_size","ask_pr","ask_size")
